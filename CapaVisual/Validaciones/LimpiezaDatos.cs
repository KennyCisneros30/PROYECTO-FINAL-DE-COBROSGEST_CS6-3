...
namespace CapaVisual.Validaciones
{
    internal class LimpiezaDatos
    {
        ...
        internal void LimpiarControladoresPagoMatricular(TextBox buscarTextBox, TextBox modeloTextBox, TextBox añoTextBox, TextBox colorTextBox, TextBox TotalTextBox, Label estadoPagoLabel)
        {
            buscarTextBox.Text = "";
            modeloTextBox.Text = "";
            añoTextBox.Text = "";
            colorTextBox.Text = "";
            TotalTextBox.Text = "";
            estadoPagoLabel.Text = "";
            estadoPagoLabel.BackColor = SystemColors.Control;
        }
